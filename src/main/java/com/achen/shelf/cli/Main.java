 ...
 * signal pass and the backtest (M5), the query API in M6. They share a process so that a demo is
 * {@code docker compose up} and a different {@code command:} per service, not a different image.
 */
@CommandLine.Command(
    name = "shelf",
